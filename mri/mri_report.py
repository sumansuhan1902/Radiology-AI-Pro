"""
MRI Report module for MedInsight AI - RadiologyAI Pro
"""
...
def show_mri_page():
    """Display the MRI report page"""
    st.markdown('<h1 class="main-header">🧠 <span class="main-header-with-gradient">MRI Scan Report Generation</span></h1>', unsafe_allow_html=True)
